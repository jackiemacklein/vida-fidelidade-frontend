        ...
        <Banners onClick={() => setOpenedMenu(false)}>
          {banners.map((item, index) => (
            <Content key={index} active={showing === index}>
              ...
              <Link className="linkB" to={process.env.REACT_APP_PAGE_CONSTRUCTION === "true" ? "/site/vida-pagamento-facil" : "/vida-pagamento-facil"}>
                <Button>CLIQUE AQUI E PAGUE SUA MENSALIDADE</Button>
              </Link>
